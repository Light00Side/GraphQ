 ...
 * This file demonstrates how to integrate Graphqledge with a web frontend
 */

// For React/Vue/Angular applications
export class GraphqledgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GraphqledgeClient(provider, contractAddress);
